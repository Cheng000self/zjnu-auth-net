...
浙江师范大学校园网 Portal 终端认证工具。适用于2026年5月1日后升级过的教学行政区的校园网认证系统。

- 校内人员使用学校统一身份认证信息作为账号和密码，认证成功后教职工账号一年内、学生账号半年内无需再次认证；非校内人员可使用手机号短信注册认证上网。

本工具提供账号密码登录、短信验证码登录、查询在线状态、注销设备等功能
